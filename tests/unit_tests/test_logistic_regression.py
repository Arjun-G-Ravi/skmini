...
class TestLogisticRegression(unittest.TestCase):
    def test_train_model_breastcancer(self):
        ...
        self.assertIsInstance(train_score, np.float64), "The accuracy should be a NumPy array"
        self.assertIsInstance(test_score, np.float64), "The accuracy should be a NumPy array"
    ...
    def test_train_custom_data(self):
        ...
        self.assertIsInstance(prediction, np.ndarray), "The accuracy should be a NumPy array"
